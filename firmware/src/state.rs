use crate::{
    ble::types::{ChargerState, Configuration, OcvMeasurement, PeriodicUpdate, QmaxUpdate, RaTableUpdate},
...
pub struct SystemState {
    ...
    pub config: StateWatch<Configuration>,
}
...
impl<'a> SystemState {
    pub fn new() -> Self {
        Self {
            ...
            config: Watch::new_with(Configuration::default()),
        }
    }
}
